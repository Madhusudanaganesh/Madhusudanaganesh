...
**Frontend Developer with 3+ years of experience** in building responsive and scalable web applications. Passionate about creating intuitive user interfaces and optimizing application performance.

- 🚀 **Core Stack:** React.js, JavaScript, TypeScript, HTML5, CSS3, and Material UI.
- 💡 **Experienced in:** Redux, React Hooks, REST APIs, Vite, Git, and Agile development.
...
<p align="left">
  ...
  <a href="https://vitejs.dev/" target="_blank" rel="noreferrer"> <img src="https://upload.wikimedia.org/wikipedia/commons/f/f1/Vitejs-logo.svg" alt="vite" width="40" height="40" style="margin-right: 10px;"/> </a>
